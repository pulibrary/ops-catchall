...
3. Booking Forms: System-wide Booking Forms can be managed from the ```Booking Forms``` tab at the top of the Locations section. Note that questions need to be added to the Question Bank before they can be added to a Booking Form. 
...
Regular users in LibCal can choose the ```Spaces``` tab in the main LibCal top menu to sort by Location and then Spaces to manage aspects of existing Spaces in the system, such as [booking availability](https://ask.springshare.com/libcal/faq/1403), booking confirmations, Space widgets, and exporting booking data. 
